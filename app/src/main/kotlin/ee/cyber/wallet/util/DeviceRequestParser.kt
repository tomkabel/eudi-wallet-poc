...
class DeviceRequestParser(
     ...
     * @throws java.lang.IllegalArgumentException if the given data isn't valid CBOR or not conforming
            ...
            request.getOrNull("docRequests")?.let { docRequests ->
                ...
                for (docRequestDataItem in docRequestsDataItems) {
                    ...
                    if (!skipReaderAuthParseAndCheck && readerAuth != null) {
                        ...
                        val signatureAlgorithm = Algorithm.Companion.fromCoseAlgorithmIdentifier(
